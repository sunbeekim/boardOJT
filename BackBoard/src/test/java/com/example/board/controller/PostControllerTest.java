...
class PostControllerTest {
        ...
        private final String tokenUser = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0ZXN0QHRlc3QuY29tIiwiaWQiOjExLCJuaWNrbmFtZSI6InRlc3QiLCJyb2xlIjoiUk9MRV9BRE1JTiIsImlhdCI6MTc0NDcwMzY2MSwiZXhwIjoxNzQ0NzkwMDYxfQ.Pfpaw0_AFkV_4_peWl0CY1qegJBs_x-cqlIQLt_pFDs";

        private final String tokenAdmin = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbkBhZG1pbi5jb20iLCJpZCI6MTAsIm5pY2tuYW1lIjoiQWRtaW4iLCJyb2xlIjoiUk9MRV9BRE1JTiIsImlhdCI6MTc0NDcwMzU4MywiZXhwIjoxNzQ0Nzg5OTgzfQ.F7vhdPb2Qft956AtDTg5Vzt5-hpcNnKvyBetvm3EWIo";
                ...
                mockMvc.perform(get("/api/posts")
                                ...
                                .andDo(document("search-posts",
                                                responseFields(
                                                                ...
                                                                fieldWithPath("data[].userId").description("작성자 ID"),
                                                                fieldWithPath("data[].viewCount").description("조회수"),
                                                                fieldWithPath("data[].commentCount")
                                                                                .description("댓글 수"),
                                                                fieldWithPath("data[].createdAt").description("생성 시간"),
                                                                fieldWithPath("data[].updatedAt").description("수정 시간"),
                                                                fieldWithPath("error").description("에러 정보 (nullable)"),
        ...
        void updatePostFailTest_dueToUnauthorized() throws Exception {
                ...
                doThrow(new UnauthorizedException("게시글 수정 권한이 없습니다."))
        ...
        void deletePostFailTest_dueToNotFound() throws Exception {
                ...
                doThrow(new BusinessException("존재하지 않는 게시글입니다.", "NOT_FOUND", 404))
